function globus-setup
  ...
  myproxy-init -s myproxy.cern.ch -l nagios -c 0 -x -Z "/DC=ch/DC=cern/OU=Organic Units/OU=Users/CN=samtf/CN=555091/CN=Robot: SAM Test Framework" -n -k NagiosRetrieve-ETF-ops
end
